...
log4j = {
    appenders {
        ...
        rollingFile name: "application",
                ...
                file: "${catalinaBase}/logs/application.log"

         // log for generic application messages
        rollingFile name: "database",
                maxBackupIndex: 5,
                threshold: org.apache.log4j.Level.INFO,
                layout: pattern(conversionPattern: '%d{ISO8601} %-5p %-30.30c [%t] - %m%n'),
                file: "${catalinaBase}/logs/db.log"
    ...
    debug application: 'grails.app'  // logger for all controllers/services/taglibs/filters

    debug database: 'org.hibernate'
    ...
    error   'org.codehaus.groovy.grails',
            ...
            'grails.app.taglib.org.grails.plugin'   // grails plugins, e.g. resources plugin
}
